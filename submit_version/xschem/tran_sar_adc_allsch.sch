...
C {advanced_mimcap_array8x8_15step.sym} 1350 -270 0 0 {name=xCDAC_CAP}
C {SW_CDAC_NEW.sym} 1500 -500 0 1 {name=xSW_SC}
C {comp_20240331.sym} 1850 -880 0 0 {name=xComp}
C {LATCH.sym} 2290 -890 0 0 {name=xLATCH}
