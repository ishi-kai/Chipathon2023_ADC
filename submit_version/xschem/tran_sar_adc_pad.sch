...
C {user_proj_sarlogic.sym} 2970 -870 0 0 {name=x_SAR_LOGIC prefix=user_proj_sarlogic}
...
C {advanced_mimcap_array8x8_15step.sym} 1350 -270 0 0 {name=xCDAC_CAP prefix=CAP_ARRAY}
C {comp_20240331.sym} 1850 -880 0 0 {name=xComp prefix=COMP}
C {SW_CDAC_NEW_RC.sym} 1500 -500 0 1 {name=xSW_SC prefix=SW_CDAC}
...
C {devices/lab_pin.sym} 2920 -260 0 1 {name=p32 sig_type=std_logic lab=CDACDMY}
...
C {LATCH_RC.sym} 2290 -890 0 0 {name=x1 prefix=LATCH}
...
C {devices/lab_pin.sym} 2610 -1440 0 0 {name=p41 sig_type=std_logic lab=DIGITAL_OUT[2]}
C {devices/lab_pin.sym} 2610 -1390 0 0 {name=p42 sig_type=std_logic lab=DIGITAL_OUT[1]}
C {devices/lab_pin.sym} 2610 -1340 0 0 {name=p43 sig_type=std_logic lab=DIGITAL_OUT[0]}
...
C {ldo.sym} 3350 -460 0 1 {name=xLDO}
...
C {SW_CDAC_NEW_RC.sym} 1740 -500 0 1 {name=xSW_SC1 prefix=SW_CDAC}
C {SW_CDAC_NEW_RC.sym} 1960 -500 0 1 {name=xSW_SC2 prefix=SW_CDAC}
C {SW_CDAC_NEW_RC.sym} 2180 -500 0 1 {name=xSW_SC3 prefix=SW_CDAC}
C {SW_CDAC_NEW_RC.sym} 2400 -500 0 1 {name=xSW_SC4 prefix=SW_CDAC}
C {SW_CDAC_NEW_RC.sym} 2620 -500 0 1 {name=xSW_SC5 prefix=SW_CDAC}
C {SW_CDAC_NEW_RC.sym} 2840 -500 0 1 {name=xSW_SC6 prefix=SW_CDAC}
C {SW_CDAC_NEW_RC.sym} 3060 -500 0 1 {name=xSW_SC7 prefix=SW_CDAC}
