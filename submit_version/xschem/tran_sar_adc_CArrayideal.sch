...
while vin_act le stop_vin
	...
	print vin >> sar_adc_tran_out_typ_CArrayideal.txt
	print vout5 >> sar_adc_tran_out_typ_CArrayideal.txt
	print vout4 >> sar_adc_tran_out_typ_CArrayideal.txt
	print vout3 >> sar_adc_tran_out_typ_CArrayideal.txt
	print vout2 >> sar_adc_tran_out_typ_CArrayideal.txt
	print vout1 >> sar_adc_tran_out_typ_CArrayideal.txt
	print vout0 >> sar_adc_tran_out_typ_CArrayideal.txt
...
C {cap_array_ideal.sym} 1350 -270 0 0 {name=xCDAC_CAP}
C {SW_CDAC_NEW.sym} 1740 -500 0 1 {name=xSW_SC1}
C {SW_CDAC_NEW.sym} 1960 -500 0 1 {name=xSW_SC2}
C {SW_CDAC_NEW.sym} 2180 -500 0 1 {name=xSW_SC3}
C {SW_CDAC_NEW.sym} 2400 -500 0 1 {name=xSW_SC4}
C {SW_CDAC_NEW.sym} 2620 -500 0 1 {name=xSW_SC5}
C {SW_CDAC_NEW.sym} 2840 -500 0 1 {name=xSW_SC6}
C {SW_CDAC_NEW.sym} 3060 -500 0 1 {name=xSW_SC7}
