...
digital=0
rainbow=0
y2=-0.01232e-11; i(v1).06032e-12"; i(v1) .06032e-12"; i(v1) p.06032e-12"; i(v1) p .06032e-12"; i(v1) p d.06032e-12"; i(v1) p de.06032e-12"; i(v1) p der.06032e-12"; i(v1) p deri.06032e-12"; i(v1) p deriv.06032e-12"; i(v1) p deriv(.06032e-12"; i(v1) p deriv().06032e-12"; i(v1) p deriv() .06032e-12"; i(v1) p deriv() /.06032e-12"; i(v1) p deriv() /".06032e-12"; i(v1) p deriv() /".06032e-12"
...
C {devices/lab_pin.sym} 540 -560 0 1 {name=l4 sig_type=std_logic lab=P}
C {devices/gnd.sym} 540 -350 0 0 {name=l6 lab=GND}
C {mim_cap_array8x8_15step.sym} 340 -490 0 0 {name=x2 prefix=TOP}
